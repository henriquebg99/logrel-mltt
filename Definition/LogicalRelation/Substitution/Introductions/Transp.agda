...
module Definition.LogicalRelation.Substitution.Introductions.Transp (equiv : E.Equiv) {{eqrel : ER.EqRelSet equiv}} where
...
open import Definition.LogicalRelation.Irrelevance equiv as I
